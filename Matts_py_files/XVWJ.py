#!/usr/bin/env python3
"""
GSQ Polygon Data Downloader - GUI VERSION
=========================================

Graphical user interface version with buttons, dropdowns, and folder selection.
...
pyinstaller --onefile --windowed gsq_gui_downloader.py
...
class GSQDownloaderGUI:
    """
    GUI application for GSQ polygon data downloading.
    """
    
    def __init__(self, root):
        self.root = root
        self.root.title("GSQ Polygon Data Downloader v4.0")
