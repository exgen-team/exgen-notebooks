...
class GSQDownloaderGUI:
    ...
    def __init__(self, root):
        self.root = root
        self.root.title("Xenith Custom GSQ Polygon Data Downloader v4.1 (Developed by Matheus Andrade)")
    ...
    def setup_ui(self):
        ...
        title_label = ttk.Label(main_frame, text="🌏 XENITH GSQ Polygon Data Downloader", 
                               font=('Arial', 16, 'bold'))
    ...
    def validate_coords(self):
        ...
        try:
            ...
            if len(coords) >= 3:
                messagebox.showinfo("Validation", f"✅ Valid polygon with {len(coords)-1} vertices")
            else:
